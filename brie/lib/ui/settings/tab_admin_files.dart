...
class TabFiles extends HookConsumerWidget {
  ...
  Future<void> onClick(
    ...
    TextEditingController completeDirController,
  ) async {
...
final directoryListingsProvider =
    FutureProvider.family<ListDirectoriesResponse, String>((
      ref,
      path,
    ) async {
...
class FilePicker extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void navigateUp() {
      final split = currentPath.value.replaceAll(r"\", "/").split("/");
