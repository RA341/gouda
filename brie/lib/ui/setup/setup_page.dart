...
class _SetupPageState extends ConsumerState<SetupPage> {
  ...
  late final setupPages = <(Widget, Future<String> Function() validateFunc)>[
    ...
    (FinalizeSetup(settingsNotifier: settingsModifier), () async => ""),
  ];
  ...
  Future<bool> validatePage(int page) async {
    ...
    showErrorDialog(context, "Error validating", errReason);
    return false;
  }
}
      ...
      children: [
        ...
        ElevatedButton(
          onPressed: () async {
            ...
            if (err.isNotEmpty) {
              showErrorDialog(context, "Error connecting to client", err);
              return;
            }
...
class FinalizeSetup extends ConsumerWidget {
  const FinalizeSetup({required this.settingsNotifier, super.key});
