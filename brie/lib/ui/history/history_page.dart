...
class MediaActionBar extends HookConsumerWidget {
...
class AddMediaPopup extends HookConsumerWidget {
                ...
                children: [
                  ...
                  Flexible(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (str) =>
                          bookData.value.seriesNumber = int.tryParse(str) ?? 0,
                    ),
                  ),
                ],
              ),
...
class HistoryView extends HookConsumerWidget {
  const HistoryView({required this.requestHistory, super.key});
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final seriesStr =
                        (request.series.isEmpty || request.seriesNumber == 0)
