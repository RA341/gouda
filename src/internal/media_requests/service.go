...
func (srv *MediaRequestService) Search(query string) ([]*RequestTorrent, error) {
...
func (srv *MediaRequestService) List(limit, offset int) (int64, []*RequestTorrent, error) {
	if pkg.IsDebugMode() {
...
func (srv *MediaRequestService) Edit(mediaRequest *RequestTorrent) error {
...
func (srv *MediaRequestService) Exists(mamID uint64) (*RequestTorrent, error) {
	var torrent RequestTorrent
...
func (srv *MediaRequestService) Retry(mediaId uint64) (*RequestTorrent, error) {
	var torrRequest RequestTorrent
...
func (srv *MediaRequestService) AddMedia(mediaRequest *RequestTorrent) error {
...
func (srv *MediaRequestService) countRecords() (int64, error) {
	var count int64 = 0
	resp := srv.db.Model(&RequestTorrent{}).Count(&count)
	if resp.Error != nil {
