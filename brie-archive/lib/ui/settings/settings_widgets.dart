...
class GeneralGroup extends BaseSettingsGroup {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final downloadCheckTimeout = useTextEditingController(
      text: value.downloadCheckTimeout.toString(),
    );
...
class TorrentGroup extends BaseSettingsGroup {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final torrentHost = useTextEditingController(
      text: value.client.torrentHost,
    );
    final clientType = useTextEditingController(text: value.client.torrentName);
    final torrentPassword = useTextEditingController(
      text: value.client.torrentPassword,
    );
    final torrentProtocol = useTextEditingController(
      text: value.client.torrentProtocol,
    );
    final torrentUser = useTextEditingController(
      text: value.client.torrentUser,
    );
